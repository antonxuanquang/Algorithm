...
public class Model {
	public void fetchData(BufferedWriter bw, String site) throws Exception{
		URL url;
		// get URL content
		url = new URL("http://waterdata.usgs.gov/nwis/dv?referred_module=sw&search_site_no=" +
				site +
				"&search_site_no_match_type=exact&site_tp_cd=OC&site_tp_cd=OC-CO&site_tp_cd=ES&site_tp_cd=LK&site_tp_cd=ST&site_tp_cd=ST-CA&site_tp_cd=ST-DCH&site_tp_cd=ST-TS&group_key=NONE&sitefile_output_format=html_table&column_name=agency_cd&column_name=site_no&column_name=station_nm&range_selection=date_range&begin_date=1916-11-01&end_date=2016-11-09&format=rdb&date_format=YYYY-MM-DD&rdb_compression=value&list_of_search_criteria=search_site_no%2Csite_tp_cd%2Crealtime_parameter_selection");
...
//				System.out.println(inputLine);
	...
	private String preProcess(String inputLine) {
		String[] components = inputLine.split("\t");
		if (!components[0].equals("USGS")) return "";
